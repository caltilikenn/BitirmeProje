...
//--------------------------------------------------------------------------------------------------
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE VUCUT_OLCULERI(ID INTEGER, OLCUM_ALANI TEXT, BOYUT INTEGER, TARIH TEXT NOT NULL, PRIMARY KEY(ID,TARIH,SAAT), FOREIGN KEY(ID) REFERENCES KULLANICILAR(ID) ON DELETE CASCADE)");
